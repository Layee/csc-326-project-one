...
int main() {
	...
	mySequence.push_back("Apple");
	mySequence.push_back("Orange");
	mySequence.push_back("Peach");
	...
	while (prompt) {
		...
		cout << " 8 - Push or Append at the end of the container Sequence.\n";
		...
		case 6:
			...
			cout << " The font element is: " << checkElement;
			break;
